...
namespace UtilityLib.Device
{
    class CrevisFnIO
    {
        ...
        public int FNIO_DevWriteOutputImage(IntPtr hDevice, int Addr, byte[] pBuffer, int Len)
        {
            return DevWriteOutputImage(hDevice, Addr, ref pBuffer[0], Len);
        }
        ...
        public string GetErrName(int Err)
        {
            switch (Err)
            {
                // FNIO_ERROR_TYPE							
                case FNIO_ERROR_SUCCESS:
                    return "FNIO_ERROR_SUCCESS"; // 0;
                case FNIO_ERROR_DEVICE_CONNECT_FAIL:
                    return "FNIO_ERROR_DEVICE_CONNECT_FAIL"; // -1;
                case FNIO_ERROR_MAX_CONNECTION_EXCEEDED:
                    return "FNIO_ERROR_MAX_CONNECTION_EXCEEDED"; // -2;
                case FNIO_ERROR_ILLEGAL_DEVICE_TYPE:
                    return "FNIO_ERROR_ILLEGAL_DEVICE_TYPE"; // -3;
                case FNIO_ERROR_SYSTEM_ALREADY_INIT:
                    return "FNIO_ERROR_SYSTEM_ALREADY_INIT"; // -4;
                case FNIO_ERROR_SYSTEM_ALLOC_FAIL:
                    return "FNIO_ERROR_SYSTEM_ALLOC_FAIL"; // -5;
                case FNIO_ERROR_SYSTEM_NOT_EXIST:
                    return "FNIO_ERROR_SYSTEM_NOT_EXIST"; // -6;
                case FNIO_ERROR_SYSTEM_CHECK_FAIL:
                    return "FNIO_ERROR_SYSTEM_CHECK_FAIL"; // -7;
                case FNIO_ERROR_WRITE_ONLY_COMMAND:
                    return "FNIO_ERROR_WRITE_ONLY_COMMAND"; // -8;
                case FNIO_ERROR_READ_ONLY_COMMAND:
                    return "FNIO_ERROR_READ_ONLY_COMMAND"; // -9;
                case FNIO_ERROR_NOT_DEFINE_COMMAND:
                    return "FNIO_ERROR_NOT_DEFINE_COMMAND"; // -10;
                case FNIO_ERROR_NOT_SUPPORT_COMMAND:
                    return "FNIO_ERROR_NOT_SUPPORT_COMMAND"; // -11;
                case FNIO_ERROR_DUPLICATE_CONNECT:
                    return "FNIO_ERROR_DUPLICATE_CONNECT"; // -12;
                case FNIO_ERROR_DEVICEINFO_ALLOC_FAIL:
                    return "FNIO_ERROR_DEVICEINFO_ALLOC_FAIL"; // -13;
                case FNIO_ERROR_DEVICE_ALLOC_FAIL:
                    return "FNIO_ERROR_DEVICE_ALLOC_FAIL"; // -14;
                case FNIO_ERROR_UNKNOWN_MODEL:
                    return "FNIO_ERROR_UNKNOWN_MODEL"; // -15;
                case FNIO_ERROR_BUFFERSIZE_SMALL:
                    return "FNIO_ERROR_BUFFERSIZE_SMALL"; // -16;
                case FNIO_ERROR_DEVICE_INDEX_EXCESS:
                    return "FNIO_ERROR_DEVICE_INDEX_EXCESS"; // -17;
                case FNIO_ERROR_NOT_EXECUTE:
                    return "FNIO_ERROR_NOT_EXECUTE"; // -18;
                case FNIO_ERROR_DEVICE_CHECK_FAIL:
                    return "FNIO_ERROR_DEVICE_CHECK_FAIL"; // -19;
                case FNIO_ERROR_PORT_ALLOC_FAIL:
                    return "FNIO_ERROR_PORT_ALLOC_FAIL"; // -20;
                case FNIO_ERROR_IO_MODULE_ALLOC_FAIL:
                    return "FNIO_ERROR_IO_MODULE_ALLOC_FAIL"; // -21;
                case FNIO_ERROR_BUFFER_ALLOC_FAIL:
                    return "FNIO_ERROR_BUFFER_ALLOC_FAIL"; // -22;
                case FNIO_ERROR_NULL_BUFFER:
                    return "FNIO_ERROR_NULL_BUFFER"; // -23;
                case FNIO_ERROR_LIST_INDEX_EXCESS:
                    return "FNIO_ERROR_LIST_INDEX_EXCESS"; // -24;
                case FNIO_ERROR_SLOT_CHECK_FAIL:
                    return "FNIO_ERROR_SLOT_CHECK_FAIL"; // -25;
                case FNIO_ERROR_NOT_DEFINE_DATAINFO:
                    return "FNIO_ERROR_NOT_DEFINE_DATAINFO"; // -26;
                case FNIO_ERROR_NOT_SUPPORT_DATAINFO:
                    return "FNIO_ERROR_NOT_SUPPORT_DATAINFO"; // -27;
                case FNIO_ERROR_NOT_DEFINE_EVENT:
                    return "FNIO_ERROR_NOT_DEFINE_EVENT"; // -28;
                case FNIO_ERROR_NOT_AVAILABLE_PORT:
                    return "FNIO_ERROR_NOT_AVAILABLE_PORT"; // -29;
                case FNIO_ERROR_INVALID_IMAGE_ADDRESS:
                    return "FNIO_ERROR_INVALID_IMAGE_ADDRESS"; // -30;
                case FNIO_ERROR_INVALID_IMAGE_LENGHT:
                    return "FNIO_ERROR_INVALID_IMAGE_LENGHT"; // -31;
                case FNIO_ERROR_INVALID_BIT_INDEX:
                    return "FNIO_ERROR_INVALID_BIT_INDEX"; // -32;
                case FNIO_ERROR_COMPORT_ALLOC_FAIL:
                    return "FNIO_ERROR_COMPORT_ALLOC_FAIL"; // -33;
                case FNIO_ERROR_COMPORT_OPEN_FAIL:
                    return "FNIO_ERROR_COMPORT_OPEN_FAIL"; // -34;
                case FNIO_ERROR_SERPORT_ALREADY_IN_USE:
                    return "FNIO_ERROR_SERPORT_ALREADY_IN_USE"; // -35;
                case FNIO_ERROR_NODEADDR_ALREADY_IN_USE:
                    return "FNIO_ERROR_NODEADDR_ALREADY_IN_USE"; // -36;
                case FNIO_ERROR_DIFFERENT_SERIAL_INFO:
                    return "FNIO_ERROR_DIFFERENT_SERIAL_INFO"; // -37;
                case FNIO_ERROR_NOT_SEND_MESSAGE:
                    return "FNIO_ERROR_NOT_SEND_MESSAGE"; // -38;
                case FNIO_ERROR_DIFFERNT_PORT_TYPE:
                    return "FNIO_ERROR_DIFFERNT_PORT_TYPE"; // -39;
                case FNIO_ERROR_NOT_WORK_IO_UPDATE:
                    return "FNIO_ERROR_NOT_WORK_IO_UPDATE"; // -40;


                // Device protocol errors 

                //Modbus TCP
                case FNIO_ERROR_ILLEGAL_FUNCTION:
                    return "FNIO_ERROR_ILLEGAL_FUNCTION"; // 1;
                case FNIO_ERROR_ILLEGAL_DATA_ADDRESS:
                    return "FNIO_ERROR_ILLEGAL_DATA_ADDRESS"; // 2;
                case FNIO_ERROR_ILLEGAL_DATA_VALUE:
                    return "FNIO_ERROR_ILLEGAL_DATA_VALUE"; // 3;
                case FNIO_ERROR_SLAVE_DEVICE_FAILURE:
                    return "FNIO_ERROR_SLAVE_DEVICE_FAILURE"; // 4;
                case FNIO_ERROR_ACKNOWLEDGE:
                    return "FNIO_ERROR_ACKNOWLEDGE"; // 5;
                case FNIO_ERROR_SLAVE_DEVICE_BUSY:
                    return "FNIO_ERROR_SLAVE_DEVICE_BUSY"; // 6;
                case FNIO_ERROR_MEMORY_PARITY_ERROR:
                    return "FNIO_ERROR_MEMORY_PARITY_ERROR"; // 8;
                case FNIO_ERROR_GATEWAY_PATH_UNAVAILABLE:
                    return "FNIO_ERROR_GATEWAY_PATH_UNAVAILABLE"; // 10;
                case FNIO_ERROR_GATEWAY_TARGET_DEVICE_FAILED_TO_RESPOND:
                    return "FNIO_ERROR_GATEWAY_TARGET_DEVICE_FAILED_TO_RESPOND"; // 11;
                case FNIO_ERROR_UNKNOW:
                    return "FNIO_ERROR_UNKNOW"; // 14;
                case FNIO_ERROR_ILLEGAL_TRANSACTION_ID:
                    return "FNIO_ERROR_ILLEGAL_TRANSACTION_ID"; // 15;
                case FNIO_ERROR_TRANSACTION_TIMEOUT:
                    return "FNIO_ERROR_TRANSACTION_TIMEOUT"; // 16;
                case FNIO_ERROR_ILLEGAL_PROTOCOL_TYPE:
                    return "FNIO_ERROR_ILLEGAL_PROTOCOL_TYPE"; // 19;
                case FNIO_ERROR_NETWORK_IS_BUSY:
                    return "FNIO_ERROR_NETWORK_IS_BUSY"; // 20;
                case FNIO_ERROR_NETWORK_ERROR:
                    return "FNIO_ERROR_NETWORK_ERROR"; // 21;
                case FNIO_ERROR_ILLEGAL_PROTOCAL_ID:
                    return "FNIO_ERROR_ILLEGAL_PROTOCAL_ID"; // 22;
                case FNIO_ERROR_ILLEGAL_UNIT_ID:
                    return "FNIO_ERROR_ILLEGAL_UNIT_ID"; // 23;

                //Modbus Serial
                case FNIO_ERROR_ILLEGAL_NODE_ADDRESS:
                    return "FNIO_ERROR_ILLEGAL_NODE_ADDRESS"; // 30;
                case FNIO_ERROR_CRC_CHECK_FAIL:
                    return "FNIO_ERROR_CRC_CHECK_FAIL"; // 31;
                default:
                    return Err.ToString();
            }
        }
